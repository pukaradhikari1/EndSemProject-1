...
public:
    ...
    QPushButton *pushButton_GraphsPieChart;
...
"}"));
        ...
        horizontalLayoutWidget_6->setGeometry(QRect(150, 220, 661, 80));
        horizontalLayout_7 = new QHBoxLayout(horizontalLayoutWidget_6);
        horizontalLayout_7->setObjectName("horizontalLayout_7");
        horizontalLayout_7->setContentsMargins(0, 0, 0, 0);
        pushButton_GraphsLineGraph = new QPushButton(horizontalLayoutWidget_6);
        pushButton_GraphsLineGraph->setObjectName("pushButton_GraphsLineGraph");
        pushButton_GraphsLineGraph->setFont(font8);

        horizontalLayout_7->addWidget(pushButton_GraphsLineGraph);

        pushButton_GraphsBarGraph = new QPushButton(horizontalLayoutWidget_6);
        pushButton_GraphsBarGraph->setObjectName("pushButton_GraphsBarGraph");
        pushButton_GraphsBarGraph->setFont(font8);

        horizontalLayout_7->addWidget(pushButton_GraphsBarGraph);

        pushButton_GraphsPieChart = new QPushButton(horizontalLayoutWidget_6);
        pushButton_GraphsPieChart->setObjectName("pushButton_GraphsPieChart");
        pushButton_GraphsPieChart->setFont(font8);

        horizontalLayout_7->addWidget(pushButton_GraphsPieChart);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        pushButton_GraphsPieChart->setText(QCoreApplication::translate("MainWindow", "Pie Chart", nullptr));
